...
* [Docker](docker/README.md)
    * [CoreOS](docker/coreos/README.md)
        ...
        * [PXE 启动（已废弃）](docker/coreos/boot-pxe.md)
        * [PXE 启动](docker/coreos/boot-pxe-new.md)
        * [iPXE 启动](docker/coreos/boot-ipxe.md)
        * [硬盘安装（已废弃）](docker/coreos/install-disk.md)
        * [硬盘安装](docker/coreos/install-disk-new.md)
        * [系统升级](docker/coreos/update.md)
